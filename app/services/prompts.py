...
2. 'astrological_analysis': Профессиональный разбор.
   - ТЕКУЩИЕ ТРАНЗИТЫ: Опиши транзиты. ВНИМАНИЕ: Строго сверяй поле 'house' для каждой планеты. Если планеты находятся в разных домах (например, Луна в 5-м, Венера в 6-м) — пиши про них РАЗДЕЛЬНО. Запрещено группировать их в один дом ради красоты текста.
   - САМЫЕ СИЛЬНЫЕ ДОМА: Перечисли ВСЕ сильные дома из {super_power}. Объясни, как они вместе создают опору.
